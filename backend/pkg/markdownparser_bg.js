...
* @returns {string}
*/
export function nanoid_gen(size) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.nanoid_gen(retptr, size);
...
/**
*/
export const QuestionType = Object.freeze({ Radio:0,"0":"Radio",Checkbox:1,"1":"Checkbox",Text:2,"2":"Text", });
/**
*/
export const Types = Object.freeze({ checkbox:0,"0":"checkbox",radio:1,"1":"radio",text:2,"2":"text", });

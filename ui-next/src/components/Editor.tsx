...
export default function Editor({ URL, editor, setEditor, setSurvey }) {
    ...
    function sendSurveyTestRequest() {
        console.log('setting survey soon...');
        let result = fetch(`${URL}/surveys/test`, {
            method: "POST",
            body: JSON.stringify({
                plaintext: editor
            }),
    ...
    return (
        <>
            <div className={"m-5 p-3 rounded-xl bg-lime-400 min-w-full min-h-full border-red-500 dark:bg-gray-800 "}>

...
//         className={
//           active
//             ? "flex-grow p-1 m-1 text-xs rounded outline outline-1 bg-green"
//             : "flex-grow p-1 m-1 text-xs rounded outline outline-1"
//         }
//         onClick={onClick}
//       >
//         {item.tabname}
...
//         <div className="flex flex-col flex-1 p-2 w-full md:w-1/2">
//           <textarea
//             className="p-2 w-full rounded-xl border border-solid"
//             style={{ height: "65vh" }}

...
export function Signup() {
  ...
  return (
    <>
      {!loggedIn && (
        <div className="flex items-center justify-center min-h-screen w-240">
          <div className="max-w-sm p-6 space-y-6 bg-white border border-gray-200 rounded-lg shadow-lg dark:border-gray-700">
            <h1 className="space-y-2 text-3xl font-bold">Signup</h1>
            <div className="space-y-4 text-left">
              <form onSubmit={onSubmit}>
                ...
                <Button
                  className="w-full p-2 border shadow-md hover:bg-slate-400"
                  type="submit"
                >
                  Signup
                </Button>
